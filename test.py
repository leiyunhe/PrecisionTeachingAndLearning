...
payload = {'since':'2017-01-01T00:00:00Z','until':'2017-03-11T00:00:00Z','access_token':tk}
...
r = requests.get("https://github.com/leiyunhe/PrecisionTeachingAndLearning.git", params = payload)
